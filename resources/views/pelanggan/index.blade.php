            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-10 gap-1">
                        {{-- <button onclick="window.location.replace('{{ route('pelanggan.available') }}')"
                            ...
                            Tersedia</button>
                        <button onclick="window.location.replace('{{ route('pelanggan.unavailable') }}')"
                        ...
                        <button type="button"
                            ...
                            onclick="window.location.replace('{{ route('pelanggan.create') }}')">+ Tambah Pelanggan</button>
                    </div>
